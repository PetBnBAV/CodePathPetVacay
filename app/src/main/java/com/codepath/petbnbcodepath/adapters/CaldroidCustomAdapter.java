...
public class CaldroidCustomAdapter extends CaldroidGridAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView ivPin = (ImageView) cellView.findViewById(R.id.ivPin);
        ...
        if ((minDateTime != null && dateTime.lt(minDateTime))
            ...
            if (CaldroidFragment.disabledBackgroundDrawable == -1) {
                ...
                cellView.setBackgroundResource(R.color.gg_light_gray);
            } else {
        ...
        if (selectedDates != null && selectedDates.indexOf(dateTime) != -1) {
            if (CaldroidFragment.selectedBackgroundDrawable != -1) {
                ...
                cellView.setBackgroundResource(resources.getColor(R.color.teal));
            } else {
//                cellView.setBackgroundColor(resources
//                        .getColor(com.caldroid.R.color.caldroid_sky_blue));
                cellView.setBackgroundColor(com.caldroid.R.drawable.disable_cell);
                ivPin.setImageResource(R.drawable.pin);
